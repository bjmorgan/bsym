...
class Configuration:
    ...
    def matches(self,
                test_configuration: Configuration) -> bool:
        """
    ...
    def is_equivalent_to(self,
                         ...
                         symmetry_operations: List[SymmetryOperation]) -> bool:
        """
    ...
    def is_in_list(self,
                   the_list: List[Configuration]) -> bool:
        """
        ...
        return next((True
                     for c in the_list
                     if self.matches(c)), False)

    def has_equivalent_in_list(self,
        ...
        return next((True
                     for c in the_list
                     if self.is_equivalent_to(c, symmetry_operations)), False)

    def set_lowest_numeric_representation(self,
       ...
       Returns:
           None
       """
       self.lowest_numeric_representation = min([symmetry_operation.operate_on(self).as_number
                                                 for symmetry_operation in symmetry_operations])
...
def as_number(a: Union[List[int], np.ndarray]) -> int:
    tot = 0
    for num in a:
        tot *= 10
        tot += int( num )
